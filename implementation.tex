...
\begin{itemize}
  ...
  \item pages/\{\{ID\}\} - Henter ut en spesifikk side. Inneholder data om alle komponentene som er på siden og verdien til feltene til komponentene.
  \item menus - Henter ut en liste med alle menyer og deres lokasjon.
  \item menus/\{\{ID\}\} - Henter ut en spesifikk meny. Her følger med alle linker som menyen har.
\end{itemize}

\section{Oppsett av chat}
Vi bestemte oss for å sette opp en livechat løsning fra Hubspot\footnote{\url{https://www.hubspot.com/products/crm/live-chat}}, men ønsket at det skulle være lett for Sirkus Media å endre til en annen løsning. Derfor endte vi opp med å måtte legge til ekstra funksjonalitet i CMS'et. Det ble opprettet CRUD for innstillinger, som man kan hente ut via API'et. I innstillingene kan brukere endre hvilket script for livechat som blir linket til.
...
\section{Første versjon av CMS og nettsted}
Figur \ref{fig:first-version-cms} viser første versjon av CMS-et og figur \ref{fig:first-version-website} viser første versjon av nettstedet.
