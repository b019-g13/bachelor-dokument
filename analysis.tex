...
Dribbble er et nettsted for deling av design verk. Det brukes ofte som en kilde for inspirasjon\footnote{\url{https://dribbble.com/about}}.

\subsubsection{Adobe Behance}
Behance er et nettsted for deling av design verk. Det brukes ofte som en kilde for inspirasjon\footnote{\url{https://help.behance.net/hc/en-us/articles/204483894-What-is-Behance-}}.
...
WordPress er gratis programvare med åpen kildekode som kan brukes til å utvikle nettside, blogger eller apper. I Wordpress er det også mulig å legge til ekstra funksjonalitet via utvidelser, som gjør det mulig å for eksempel legge til gallerier, postlister og analyser.
...
\item[Brandwoods A11y-test] Ble valgt fordi det var den mest intuitive verktøyet vi fant som kunne utføre jobben det gjør.
\item[Qualys SSL Server Test] 
\item[Google Transparency Report - Safe Browsing: malware and phishing]
\item[Figma] Ble valgt fordi det var enkelt å bruke og veldig intuitivt. I tillegg er det gratis, i motsetning til f.eks. Photoshop.
\item[Laravel] Ble valgt fordi en av gruppemedlemmene har erfaring med det, og det gjør at man kommer kjapt i gang.

\item[PHP] Ble valgt fordi det er et relativt \q{snillt} og fleksibelt språk
som er enkelt å komme i gang med.
\item [GNU/Linux] Ble valgt fordi det er sikkert, stabilt og fleksibelt samt at en av gruppemedlemmene har erfaring med det.

\item[Nginx] Ble valgt ettersom en av gruppemedlemmene har erfaring med det.
\item[phpMyAdmin] Ble valgt ettersom alle gruppemedlemmene har erfaring med det.
...
nt\item[Buddy]
\item[Ottomatik.io] Ble valgt ettersom en av gruppemedlemmene har erfaring med det.
\item[Amazon S3] Ble valgt ettersom en av gruppemedlemmene har erfaring med det.
\item[Let’s Encrypt] Ble valgt ettersom en av gruppemedlemmene har erfaring med det.
...
\item[Axios] Ble valgt fordi det er brukervennlig og veldig intuitivt.
\item[React] Ble valgt fordi det er populært, har god dokumentasjon og noen av gruppemedlemmene ønsket lære seg denne teknologien.
...
\begin{itemize}
    ...
    \item Alt kan tilpasses og det er lett å styre hvordan tingene fungerer.
    \item Databasen kan brukes eller utformes på egen måte.
\end{itemize}

\textbf{Ulemper med Laravel}
\begin{itemize}
    \item I Laravel må SEO definere egne ruter, og det tar mye arbeid å utvikle et nettsted som hovedsakelig er avhengig av innhold. Her får man mye \q{gratis} hjelp av Wordpress.
    \item Laravel rammeverk er litt komplisert og krever mer kunnskap for å sette seg inn i enn Wordpress.
    \item Laravel er mindre fleksibelt enn Wordpress når det gjelder oppdatering av innhold.
\end{itemize}
