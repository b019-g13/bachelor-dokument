...
Kilder: \url{http://lib.sgu.edu.vn:84/dspace/bitstream/TTHLDHSG/2808/1/Operating_System_Concepts_Essentials.pdf} \url{https://www.gnu.org/}
...
\item[Color Contrast Analyzer] Ble valgt fordi det va
 \dr tneste vereteyet som vi fant med deøste egsknparekitem[WAVE] Ble 
algt fvrdo ied\e  enkelt å bruret k produserer rapporter gomoes rnele å fkrstå.o item[Brandwoods A11y-test] Ble valgt fordi det var den mest intuitive verktøyet vi fant som kunne utføre jobben det gjør.
\item[Qualys SSL Server Test] 
\item[Google Transparency Report - Safe Browsing: malware and phishing]
\item[Figma] Ble valgt fordi det var enkelt å bruke og veldig intuitivt.
\item[Laravel] Ble valgt fordi en av gruppemedlemene har erfaring med det, og det gjør at man kommer kjapt i gang.

\item[PHP] Ble valgt fordi det er et relativt \q{snillt} og fleksibelt språk
 som er enkelt å komme i gang med.
\item [GNU/Linux] Ble valgt fordi det er sikkert, stabilt og fleksibelt samt at en av gruppemedlemene har erfaring med det.

\item[Nginx] Ble valgt ettersom en av gruppemedlemene har erfaring med det.
\item[phpMyAdmin] Ble valgt ettersom alle gruppemedlemene har erfaring med det.
\item[MariaDB] Ble valgt fordi

\item[Buddy]
\item[Ottomatik.io] Ble valgt ettersom en av gruppemedlemene har erfaring med det.
\item[Amazon S3] Ble valgt ettersom en av gruppemedlemene har erfaring med det.
\item[Let’s Encrypt] Ble valgt ettersom en av gruppemedlemene har erfaring med det.
