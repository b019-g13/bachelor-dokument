...
Ikonet for \q{Progressive Web App} har en feil, slik at man ikke får sett scoren. Ved hjelp av en JSON-fil som inneholder resultatene, ser man at poengsummen er på 58\%.
...
Når det kommer til SEO er det ingenting å påpeke. Noe som derimot kan være lurt å ta en titt på er hvilke JavaScript-biblioteker som blir brukt, ettersom Google kan melde at hele 5 kjente sikkerhetshull er tilgjengelig på siden. 
