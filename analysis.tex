...
Man bør skru av fjerntilgang for root brukeren og lage en egen bruker i sudo gruppen.
Man bør skru av login med passord.
Man bør skru på login med public/private key pair. Gjerne med passord på key-en.
Man bør sette maks antall forsøk på login før man blir midlertidig utestengt via IP.
Man bør skift vekk fra standard SSH port 22
Man bør sette opp en brannmur som blokker alt bortsett fra SSH porten man har satt, samt port 80 for HTTP og port 443 for HTTPS
Man bør bruke rettighetene 755 på mapper og 644 på filer som serveres offentlig.
