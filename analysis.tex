...
Kapittel 2 omhandler relevant teori og beste praksis for planlegging, design og utvikling. Vi vil også presentere noen gode eksempler når det gjelder relatert arbeid. I løpet av dette kapittelet vil vi danne oss et bilde av hvordan en nettsted bør se ut. Både med hensyn på innhold, struktur og utforming. I tillegg vil vi presentere en analyse av opprinnelig løsning, konkurrentanalyse, kravene som er satt til verktøy etterfulgt av en presentasjon av de verktøy vi mener er passende.
...
For å lage en best mulig brukeropplevelse burde man:
\begin{itemize}
...
1 \url{https://www.nngroup.com/articles/website-response-times/}
2 \url{https://barrgroup.com/Embedded-Systems/How-To/User-Interface-Timing}
...
Indikasjon på ventetid er teknikker brukt for å informere brukeren om at systemet har motatt brukerinput opptatt og utfører en jobb. Her er det vanlig med blant annet fremdriftslinjer, spinners eller animerte ikoner og illustrasjoner. D




Users want to feel in control of the system they’re using, which means they want to know and understand their current context at any given time, and especially when a system is busy doing work



Brukere hater trege nettsider
...
I kapittel \ref{sec:viktige-faktorer} har vi kartlagt og analysert hvilke faktorer som er viktige når det kommer til webdesign. Videre i dette kapittelet vil vi presentere nettsider som har tatt hensyn til disse faktorene og fulgt beste praksis. 
...
\subsection{Struktur}
Et nettsteds struktur og oppbygning er viktig på grunn av flere faktorer.

God brukeropplevelse. Logisk rekkefølge. Letter også for universell utforming (skjermleser), de som beveger seg med kun tastaturet.
Forbedrer SEO
