...
Kapittel 2 omhandler relevant teori og praksis for planlegging, design, brukerveiledning og utvikling. I dette kapittelet vil vi danne oss et bilde av hvordan en nettsted bør se ut. Både med hensyn på innhold, struktur og utforming. 

%\lipsum[3-56]

\section{Hvorfor er et nettsted så viktig}
I dagens samfunn har bruk av internett blitt et hverdagslig gjøremål for mange. I følge Statistisk sentralbyrå\footnote{Statistisk sentralbyrå utarbeider og gir ut offisiell statistikk i Norge}  (SSB) har hele 98\% av Norges befolkning tilgang på internett hjemme. I tillegg viser statistikk gjort av SSB at så mange som 89\% av Norges befolkning brukte internett til å søke informasjon om varer eller tjenester, de siste 3 måneder i 2018.  Dette er relevante funn, og beviser hvorfor det er så viktig for en bedrift å være på internett i dag.
\url{https://www.ssb.no/teknologi-og-innovasjon/artikler-og-publikasjoner/tre-av-fire-har-handlet-pa-nett-det-siste-aret}
\url{https://www.ssb.no/statbank/table/06998/tableViewLayout1/}
-----
I følge undersøkelser gjort av SSB har likevel kun 78\% av landets foretak har en egen hjemmeside.
\url{https://www.ssb.no/teknologi-og-innovasjon/faktaside/internett-og-mobil}

\subsection{Viktige faktorer}
https://www.sciencedirect.com/science/article/pii/S014829631630203X#bb0175 

\subsubsection{Søkemotoroptimalisering}
75\% of Internet users never scroll past the first page of search results, TRENGER KILDE!!

https://www.searchenginepeople.com/blog/40-unbelievable-seo-statistics-need-know.html#note-68961-5 


\subsubsection{Troverdighet}
https://www.brightlocal.com/learn/local-consumer-review-survey/ 

\subsubsection{Design og førsteinntrykk}

\subsubsection{Markedsføringskanal}

\subsubsection{Innsamling av data}

\subsection{Praksis og begreper}

\subsubsection{Struktur og oppbygning}
\subsubsection{Hurtighet}
\subsubsection{WCAG 2.0}

\subsection{Plan}
Webdesign-prosjekter inneholder fire viktige komponenter. Første steg er at du må kjenne miljøet ditt. Andre steg er å planlegge. Tredje steg er å lære å kunne tilpasse seg, og siste steg er å fullføre prosessen ved å løse kompatibilitetsproblemer etter hvert som de oppstår. (Dawson, 2011).
...
\subsubsection{Kjenn miljøet ditt}
