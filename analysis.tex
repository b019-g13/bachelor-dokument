...
Å benytte seg av internett har i dagens samfunn blitt et hverdagslig gjøremål for mange. Undersøkelser \cite{ssb18aup,ssb17fim,ssb17nat} gjort av Statistisk sentralbyrå (SSB)\footnote{Statistisk sentralbyrå utarbeider og gir ut offisiell statistikk i Norge} er med å underbygge denne påstanden. I 2017 hadde nemlig hele 98\% av Norges befolkning tilgang på internett hjemme. Videre viser undersøkelsene at hele 9 av 10 nordmenn surfet på nettet hver dag i 2017. SSB kartla også at så mange som 89\% av Norges befolkning, mellom 16-79 år, brukte internett til å søke etter informasjon om varer eller tjenester de siste 3 måneder i 2018. Disse foregående funnene er svært relevante og er med å bevise hvorfor det er så viktig for en bedrift å være på internett i dag.
